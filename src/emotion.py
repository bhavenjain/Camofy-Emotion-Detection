...
ageList=['(25-30)', '(35-40)', '(35-37)', '(15-20)', '(25-32)', '(27-30)', '(48-53)', '(30-33)']
...
while True:
    ...
    for (x, y, w, h) in faces:
        cv2.rectangle(frame, (x+20, y+50), (x+w-20, y+h+10), (255, 0, 0), 2)
        ...
        cv2.putText(frame, f'Age: {age}', (x+150, y+40), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0,255,255), 2, cv2.LINE_AA)
...
print(MostCommon(AgeList))
print(MostCommon(GenderList))
print(MostCommon(EmotionList))
